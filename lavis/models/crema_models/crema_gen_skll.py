...
@registry.register_model("crema_gen_skll")
class CREMA_GEN_SKLL(Blip2Base):
    """
    BLIP2 T5 model.
    ...
    def _init_flow_models(self):
        ...
        self.z_vtxyp = MLPLayer(prompt_length + tlen + vlen, zlen, True)
    ...
    def forward(self, samples):
        full_modal = samples['full_modal']
        x, y, z = self.non_rgb_modalities # xy are selected, z is generated
        ...
        # # GEN step2: generate all xyz qformer input
        ...
        #             dim=2,
        #         )
        # zz = self.z_vtxyp(zz.transpose(1, 2))
        # if not full_modal:
        #     loss_rec = 0.0
        #     input_embed_dict[z] = zz
        # else:
        #     z_real = input_embed_dict[z].detach()
