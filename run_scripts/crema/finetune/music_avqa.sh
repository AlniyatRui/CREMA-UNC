...
exp_name='avqa_crema_vt_allexp_baseline1'
ckpt='crema_initial.pth'

CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.run --nproc_per_node=4 --master_port 29513 train.py \
...
datasets.musicavqa_mm_instruct.data_type=['frame'] \
